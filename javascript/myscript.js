...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "My heart is beating fast " + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
author.innerHTML = "Mọi thắc mắc bạn có thể liên hệ<a href='https://www.facebook.com/Haruto17.11'>Haru<a>";
